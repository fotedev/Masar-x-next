    ...
    <div className="text-start items-start flex flex-col">
      ...
      <div className="space-y-3">
        ...
        <a
          ...
          className="inline-flex items-center gap-x-3 px-6 py-3 bg-[#25D366] hover:bg-[#20ba5a] text-white rounded-2xl transition-all duration-300 font-bold text-sm shadow-lg shadow-green-500/20 group"
        >
          <svg
            width="20"
            height="20"
