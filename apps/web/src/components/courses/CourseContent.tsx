          ...
          {!isEnrolled ? (
            <div className="text-center py-8">
              ...
              <p className="text-gray-600 dark:text-gray-400">
                {t("content.summariesLocked")}
              </p>
            </div>
          ) : summaries.length === 0 ? (
            <p className="text-gray-500 text-center py-8">
              {t("content.noSummaries")}
            </p>
          ) : (
