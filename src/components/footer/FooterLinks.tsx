...
export function FooterLinks({
  ...
  return (
    <div className="flex flex-col h-full items-start">
      <h3 className="text-slate-900 dark:text-white font-bold mb-3 text-lg flex items-center gap-x-2">
        ...
        <ul className="space-y-0.5">
          {links.map((link) => (
            <li key={link.href}>
              <Link
                href={link.href}
                className="group flex items-center justify-between py-1 px-2 rounded-xl text-slate-600 dark:text-slate-400 hover:bg-slate-50 dark:hover:bg-slate-800/50 hover:text-brand-blue dark:hover:text-brand-blue transition-all duration-300"
              >
                ...
                <ChevronRight className="w-4 h-4 opacity-0 -translate-x-2 group-hover:opacity-100 group-hover:translate-x-0 transition-all duration-300 rtl:rotate-180 rtl:group-hover:-translate-x-0" />
              </Link>
            </li>
          ))}
        </ul>
        ...
        >
          ...
          <div className="relative z-10 text-start">
            <div className="flex items-center justify-between mb-2">
              ...
              <div className="flex items-center gap-x-1 bg-red-100 dark:bg-red-900/50 px-2 py-0.5 rounded-full">
