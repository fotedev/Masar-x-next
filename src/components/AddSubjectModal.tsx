        ...
        <div className="fixed inset-0 flex items-center justify-center p-4 z-[100]">
          ...
          >
            ...
            >
              ...
              <div>
                <label className="block text-sm font-bold text-gray-700 dark:text-gray-300 mb-1">
                  {tAddSubjectModal("professorGender")}
                </label>
                <div className="flex gap-4">
                  <label className="flex items-center gap-2 cursor-pointer">
                    <input
                      ...
                      onChange={() =>
                        setFormData({ ...formData, professor_gender: "male" })
                      }
                      className="w-4 h-4 text-blue-600 focus:ring-blue-500"
                    />
                    <span className="text-sm text-gray-700 dark:text-gray-300">
                      {tAddSubjectModal("male")}
                    </span>
                  </label>
                  <label className="flex items-center gap-2 cursor-pointer">
                    <input
                      ...
                      onChange={() =>
                        setFormData({ ...formData, professor_gender: "female" })
                      }
                      className="w-4 h-4 text-blue-600 focus:ring-blue-500"
                    />
                    <span className="text-sm text-gray-700 dark:text-gray-300">
                      {tAddSubjectModal("female")}
                    </span>
                  </label>
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  >
                    {optionsLoading ? (
                      <option>{tAddSubjectModal("optionsLoading")}</option>
                    ) : (
                      levels.map((lvl, i) => (
                        <option
                          key={lvl.id}
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full px-4 py-2 rounded-xl border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500 transition-all"
                  >
                    <option value={1}>{tAddSubjectModal("semester1")}</option>
                    <option value={2}>{tAddSubjectModal("semester2")}</option>
                  </select>
                </div>
              </div>
