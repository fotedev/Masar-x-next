...
| **005-desktop-study-workspace** | 3-column workspace, native-feel shell, frameless titlebar, dev safeguards | **84.4 %** (27/32) | In Progress | Ledger truth-synced + `verification.md` written 2026-09-23 (9be3617): packaged Electron 44 CDP evidence for T016/T025/T050, browser FR-011 probe, gates 27/27 incl. smoke. T050 responsive collapse landed (a5172f9). | T030-T034 (FR-024..027 dev safeguards) remain the only open work — deliberately deferred, not lost. T051 recorded code-verified; no in-shell locale switcher (noted gap). |
...
| **014-desktop-launch-readiness** | Electron 44 bump, masarx:// PKCE deep-link login, dead-dep removal, owner register, v0.6.0 prep | **94.4 %** (17/18) | In Progress | Commits 6b0c907, cc998dd, a07634e, abf802b, cc61646, 6818106, ca8b1e5, 174539a. Live E2E: cold-start argv→pull, warm second-instance→push, OS protocol handler→renderer; installer NSIS builds; gates green incl. 27/27 smoke. | R044 (dashboard + memory ledger) — completed with this update; then owner-only: Supabase allow-list + signing cert (docs/desktop-readiness.md) and the v0.6.0 tag. |

---


> **ADDENDUM 2026-09-23 (spec 014 execution):** 005 row re-baselined to 27/32 with ledger sync + verification.md (T053); §6 item 5 resolved; spec 014 added (17/18, R044 closed by this addendum). §5.5 and other per-spec prose sections were NOT rewritten this pass — the table + register are the source of truth as of this date. Electron pinned 44.4.5; desktop has no native modules; better-sqlite3/masarx-shared gone from apps/desktop; release.yml no longer runs install-app-deps.
...
| 5 | 005 | **RESOLVED 2026-09-23** | Ledger re-run against main: T010-T025 verified on disk + packaged app, ticked with evidence; T050/T052/T053 executed. | Done in 9be3617; remaining open set is exactly T030-T034. |
